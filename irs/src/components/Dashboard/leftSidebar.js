          ...
          <ul className="nav flex-column">
            <Dropdown nav isOpen={this.state.dropdownError} toggle={this.toggleError}>
              ...
              <DropdownMenu>
                ...
                <DropdownItem href="#" onClick={() => this.props.clickHandler('/api/lowest/error')}>
                  Lowest
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
            <Dropdown nav isOpen={this.state.dropdownPrice} toggle={this.togglePrice}>
              ...
              <DropdownMenu>
                ...
                <DropdownItem href="#" onClick={() => this.props.clickHandler('/api/lowest/price')}>
                  Lowest
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
            <Dropdown nav isOpen={this.state.dropdownVolume} toggle={this.toggleVolume}>
              ...
              <DropdownMenu>
                ...
                <DropdownItem href="#" onClick={() => this.props.clickHandler('/api/lowest/volume')}>
                  Lowest
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
